      ...
      <div className="w-full items-center justify-center text-white h-[80vh] overflow-hidden hidden xl:flex lg:mb-10 ">
        <div className="relative flex flex-col justify-center items-center lg:items-end min-w-[45%] h-full text-[9rem] ">
          <div className="absolute top-0 lg:-right-32 flex flex-col justify-start items-start lg:items-end">
            <img className="max-w-xl" src="/img/landingProfile.png" alt="" />
            <span className="block uppercase font-HelveticaBold tracking-[6px] [-webkit-text-stroke-color:#01e9de] [-webkit-text-fill-color:transparent] [-webkit-text-stroke-width:3px] relative right-[80px]">
              Patra
            </span>
          </div>
        </div>
        <div className="h-[80vh] max-w-[50%] hidden lg:block">
          <img
