        ...
        <div className="relative flex flex-col justify-center items-center lg:items-end min-w-[45%] h-full text-[9rem] ">
          <div className="absolute top-0 lg:-right-32 flex flex-col justify-start items-start lg:items-end">
            <img
              ...
              alt=""
            />
            <span className="block z-[100] uppercase font-HelveticaBold tracking-[6px] [-webkit-text-stroke-color:#01e9de] [-webkit-text-fill-color:transparent] [-webkit-text-stroke-width:3px] relative right-[80px]">
              Patra
            </span>
          </div>
        </div>
