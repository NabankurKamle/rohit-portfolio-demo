const Footer = () => {
  return (
    <div
      ...
      className="z-10 bg-[#000000] w-full backdrop-blur-xl p-4 sm:p-8 my-[6px] text-[#a2afa2] flex items-center justify-between"
    >
      <div className="w-1/2 sm:w-full">
        <p className="text-sm">Copyright 2023 - All right reserved</p>
      </div>
      <div>
        <ul className=" flex flex-col sm:flex-row sm:gap-x-6 gap-y-2 text-sm text-white">
